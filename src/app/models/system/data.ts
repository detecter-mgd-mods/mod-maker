export class Data {
    ...
    public static readonly DefaultBoolean: string[] = ["True", "False"]
    ...
    public static readonly DefaultStances: string[] = ["Empty", "Any", "Make Out", "Making Out", "Sex", "Anal", "Blowjob", "Titfuck", "Face Sit", "Footjob", "Breast Smother", "Slimed 100%", "Slimed 50%", "Slimed", "Tailjob", "All", "None"];
    public static readonly DefaultStatusEffects: string[] = ["None", "Charm", "Restrain", "Aphrodisiac", "Stun"]
    public static readonly DefaultSkill: string[] = ["Caress", "Blowjob", "Vacuum Blowjob", "Tighten", "Oral Tease", "Grind", "Double Blowjob", "Rough Ride", "Grind", "Kiss", "Deep Kiss", "Pin",
